...
This created a global variable necessary for the next part of the tutorial.  Now go to ``playState.js`` and instantiate the PlayState game state and set up some variables: 
...
![Screenshot1](/../../Users/schuetz/Desktop/GitHubTutor/Ninja-Multiplayer-Platformer/readmepics/tutorialscreen1.png)
...
![Screenshot2](/../../Users/schuetz/Desktop/GitHubTutor/Ninja-Multiplayer-Platformer/readmepics/tutorialscreen2.png)
...
![Screenshot3](/../../Users/schuetz/Desktop/GitHubTutor/Ninja-Multiplayer-Platformer/readmepics/tutorialscreen3.png)

## Handle Key Messages

Now lets add the ``handleKeyMessages()`` function to the game so we can start implementing the multiplayer components. 
